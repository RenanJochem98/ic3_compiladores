...
public class PrintTree {
    ...
    public PrintTree() {
        ...
        texto = "";
        try {    
            fw = new FileWriter("./arvore.txt");     
        } catch(Exception e) { 
            System.out.println(e); 
        }    
        System.out.println("Instanciou file writer...");    
        
    }

    public void printRoot(ListNode x) {
        if (x == null) {
            texto += "Empty syntatic tree. Nothing to be printed\n";
        } else {
    ...
    public void printClassDeclListNode(ListNode x) {
        ...
        texto += (x.number + ": ListNode (ClassDeclNode)  ===> " +
            x.node.number + " " +
    ...
    public void printClassDeclNode(ClassDeclNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ClassDeclNode ===> " + x.name.image +
    ...
    public void printVarDeclListNode(ListNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ListNode (VarDeclNode) ===> " +
            x.node.number + " " +
            ((x.next == null) ? "null" : String.valueOf(x.next.number)));
    ...
    public void printVarDeclNode(VarDeclNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": VarDeclNode ===> " + x.position.image +
            " " + x.vars.number);
    ...
    public void printvarListNode(ListNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ListNode (VarNode) ===> " +
            x.node.number + " " +
            ((x.next == null) ? "null" : String.valueOf(x.next.number)));
    ...
    public void printConstructDeclListNode(ListNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ListNode (ConstructDeclNode) ===> " +
            x.node.number + " " +
            ((x.next == null) ? "null" : String.valueOf(x.next.number)));
    ...
    public void printConstructDeclNode(ConstructDeclNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ConstructDeclNode ===> " +
            x.body.number);
    ...
    public void printMethodDeclListNode(ListNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ListNode (MethodDeclNode) ===> " +
            x.node.number + " " +
            ((x.next == null) ? "null" : String.valueOf(x.next.number)));
    ...
    public void printBlockNode(BlockNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": BlockNode ===> " + x.stats.number);
    ...
    public void printStatementListNode(ListNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ListNode (StatementNode) ===> " +
            x.node.number + " " +
            ((x.next == null) ? "null" : String.valueOf(x.next.number)));
    ...
    public void printPrintNode(PrintNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": PrintNode ===> " + x.expr.number);
    ...
    public void printReadNode(ReadNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ReadNode ===> " + x.expr.number);
        printExpreNode(x.expr);
    }
    ...
    public void printAtribNode(AtribNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": AtribNode ===> " + x.expr1.number + " " +
            x.expr2.number);
    ...
    public void printIfNode(IfNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": IfNode ===> " + x.expr.number + " " +
            x.stat1.number + " " +
    ...
    public void printNewObjectNode(NewObjectNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": NewObjectNode ===> " + x.name.image +
            " " + ((x.args == null) ? "null" : String.valueOf(x.args.number)));
    ...
    public void printNewArrayNode(NewArrayNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": NewArrayNode ===> " + x.name.image +
    ...
    public void printExpreListNode(ListNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": ListNode (ExpreNode) ===> " +
            x.node.number + " " +
            ((x.next == null) ? "null" : String.valueOf(x.next.number)));
    ...
    public void printRelationalNode(RelationalNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": RelationalNode ===> " + x.expr1.number +
    ...
    public void printAddNode(AddNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": AddNode ===> " + x.expr1.number + " " +
            x.position.image + " " + x.expr2.number);
        printExpreNode(x.expr1);
        printExpreNode(x.expr2);
    }
    ...
    public void printMultNode(MultNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": MultNode ===> " + x.expr1.number + " " +
            x.position.image + " " + x.expr2.number);
        printExpreNode(x.expr1);
        printExpreNode(x.expr2);
    }
    ...
    public void printUnaryNode(UnaryNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": UnaryNode ===> " + x.position.image +
            " " + x.expr.number);
        printExpreNode(x.expr);
    }
    ...
    public void printIntConstNode(IntConstNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": IntConstNode ===> " + x.position.image);
    }
    ...
    public void printStringConstNode(StringConstNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": StringConstNode ===> " +
            x.position.image);
    }
...
// -------------------------- Constante float ----------------------
    ...
    public void printFloatConstNode(FloatConstNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": FloatConstNode ===> " + x.position.image);
    }
    ...
    public void printNullConstNode(NullConstNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": NullConstNode ===> " + x.position.image);
    }
    ...
    public void printVarNode(VarNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": VarNode ===> " + x.position.image + " " +
            ((x.dim == 0) ? "" : ("[" + x.dim + "]")));
    }
    ...
    public void printCallNode(CallNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": CallNode ===> " + x.expr.number + " " +
            x.meth.image + " " +
            ((x.args == null) ? "null" : String.valueOf(x.args.number)));
        printExpreNode(x.expr);
        printExpreListNode(x.args);
    ...
    public void printIndexNode(IndexNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": IndexNode ===> " + x.expr1.number + " " +
            x.expr2.number);
        printExpreNode(x.expr1);
        printExpreNode(x.expr2);
    }
    ...
    public void printDotNode(DotNode x) {
        ...
        texto += "\n";
        texto += (x.number + ": DotNode ===> " + x.expr.number + " " +
            x.field.image);
        printExpreNode(x.expr);
    }
